  ...
  return (
    <section className="mx-[30px] mt-[60px] lg:mx-[76px] lg:mt-[150px]">
      <div className="flex flex-col items-center gap-[35px] md:gap-[25px]">
        ...
        >
          I can  design, code or build the product of your choice for
          your new or existing products. Please feel free to message me.
        </h3>
      ...
      >
        <div className="flex flex-col items-center gap-[10px]">
          ...
          <a
            ...
            href="mailto:jcjerry165@gmail.com"
          >
            jcjerry165@gmail.com
          </a>
        </div>
        <div className="flex flex-col items-center gap-[10px]">
        ...
        <div className="flex flex-col items-center gap-[10px]">
          ...
          >
            ...
            {timeOfDay === "afternoon" && <span>localhost:5470</span>}
